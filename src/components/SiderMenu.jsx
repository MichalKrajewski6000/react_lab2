...
const SiderMenu = () => {
  ...
  return (
    <nav style={theme === "dark" ? darkTheme : lightTheme}>
      ...
      <hr />
      {theme === "dark" && (
        <div className="list-item" onClick={() => switchTheme()}>
          Light Mode
        </div>
      )}
      {theme === "light" && (
      ...
      <div className="list-item" onClick={() => biggerFont()}>
        <Plus /> Font
      </div>
      <div className="list-item" onClick={() => smallerFont()}>
        <Minus /> Font
      </div>
    </nav>
  );
